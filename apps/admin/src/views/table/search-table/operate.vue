...
import { type FormInst, type FormRules, NInputNumber } from 'naive-ui'
...
import type { ProTableColumn, ProTableRequestParams } from '@/components'
...
async function leaderMethodRequest({
  birthDate,
  page,
  pageSize,
  ...rest
