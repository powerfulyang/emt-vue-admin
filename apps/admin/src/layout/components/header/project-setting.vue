      ...
      <div class="drawer">
        ...
        <div class="justify-center drawer-setting-item dark-switch">
          <n-tooltip placement="bottom">
            <template #trigger>
              <n-switch v-model:value="themeStore.darkTheme" class="dark-theme-switch">
                <template #checked>
            ...
            <span>{{ themeStore.darkTheme ? '深' : '浅' }}色主题</span>
          </n-tooltip>
        </div>
...
<script lang="ts" setup>
  ...
  const state = reactive({
    ...
    appThemeList: themeStore.appThemeList,
  });

  const { appThemeList, placement, alertText, isDrawer } = toRefs(state);
